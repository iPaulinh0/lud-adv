export function SelectionField() {
  return(
    <div className="flex flex-1 flex-col gap-2 mb-9">
      ...
      <select id="services"
        className="bg-blue-dark-sky border border-indigo-blue py-4 px-6 w=[37.5rem] rounded-lg text-gray-400 text-base focus:outline-none focus:border-sun-orange"
        >
