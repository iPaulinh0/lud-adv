      ...
      >
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-4">
          <a
            ...
            className="rounded-[3px] bg-gold px-8 py-4 text-[13px] font-bold tracking-[0.14em] text-ink uppercase transition-colors duration-300 hover:bg-gold-light"
          >
            Agendar Consulta
          </a>
          <button
            onClick={() => onNavigate("sobre")}
            className="cursor-pointer rounded-[3px] border border-cream/32 px-7 py-4 text-[13px] font-medium tracking-[0.14em] text-cream uppercase backdrop-blur-sm transition-colors duration-300 hover:border-gold hover:text-gold"
          >
            Conheça Ludmila
          </button>
        </div>
        ...
        <div className="mt-8 flex gap-10 lg:hidden">
          <div className="text-center">
            <div className="font-serif text-4xl leading-none text-gold">
              05<span className="text-[0.5em]">+</span>
            </div>
            <div className="mt-2 text-[10px] tracking-[0.24em] text-cream/62 uppercase">anos de atuação</div>
          </div>
          <div className="text-center">
            <div className="font-serif text-4xl leading-none text-gold">
              100<span className="text-[0.5em]">+</span>
            </div>
            <div className="mt-2 text-[10px] tracking-[0.24em] text-cream/62 uppercase">casos conduzidos</div>
          </div>
        </div>
      </Reveal>
