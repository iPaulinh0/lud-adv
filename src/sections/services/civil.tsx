  ...
  return(
    <div className="flex flex-col items-center justify-center max-sm:flex-row max-[450px]:flex-col">
            <div className="flex flex-col items-center gap-7 max-sm:gap-1 max-sm:mr-10 max-[450px]:mr-0">
              ...
              <h2 className="font-bold text-xl text-blue-sky uppercase text-center mb-2 tracking-widest max-lg:text-lg max-md:text-base max-xs:text-sm">Direito Civil</h2>
            </div>
            ...
            <Drawer>
              <DrawerTrigger
                ...
                <DrawerContent className="h-[calc(100vh-2rem)] bg-blue-night/95 backdrop-blur-sm border-gray-800 px-5">
