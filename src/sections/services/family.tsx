...
export function Family() {
  return(
    <div className="flex flex-col items-center justify-center max-sm:flex-row max-[450px]:flex-col">
            ...
            <p className="text-sm tracking-wider text-blue-sky italic text-center max-w-80 max-lg:text-xs max-sm:text-base max-xs:text-xs max-[890px]:hidden">
            ...
            <Drawer>
              <DrawerTrigger onClick={() => window.scroll(0,0)}
                ...
                <DrawerContent className="h-[calc(100vh-7.5rem)] bg-blue-night backdrop-blur-sm border-gray-800 px-5 mb-5">
